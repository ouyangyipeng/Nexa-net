...
use nexa_net::{
    discovery::embedding::{EmbeddingConfig, Embedder, create_embedder},
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let capabilities = vec![
        ("did:nexa:svc:translation", "Neural machine translation service"),
        ("did:nexa:svc:summarization", "Document summarization and extraction"),
        ("did:nexa:svc:vision", "Image classification and object detection"),
        ("did:nexa:svc:speech", "Speech-to-text transcription service"),
    ];
    ...
    use nexa_net::discovery::embedding::utils::{normalize, euclidean_distance};
